...
import icon1 from './images/Yellow_Abstract_Cooking_Fire_Free_Logo__2_-removebg-preview.png'
...
const Render = () =>{
  ...
  const [value,setValue] = useState('Paneer');
  const [fill,setFilter] = useState([]);
  const [extra,setExtra] = useState([]);


  const getdata = async(dish_call = 'Paneer') =>{
  ...
  return(
    ...
    <div className='head-main'>
      <div className='head-main-one'>
        <img src={icon1} alt="Food" className='head-icon-name'/> 
        <h2 id="head-name">RECIPE REALM</h2>
      </div>
    ...
    <div className='footer'>
      <div className='footone'>
        Created By <span className='footspan'>AMBAREESH RAM REDDY</span>
      </div>
      <div className='foottwo'>
        <a href='https://www.linkedin.com/in/ambareeshram/' target='_blank'>
          <button className='foot-button'>
            <img src= {linkedin} alt='Linked IN' className='footicon'/> 
          </button>
        </a>
        <a href='https://github.com/ambareeshram' target='_blank'>
          <button className='foot-button'>
